...
public class Scenario {
	...
	//Initialise Entities : 
	public void initEntities(IEmployManagement employees,ICarsManagement cars,IRentalsManagement rentals,IWaitingManagement WaitingLists,IFeedBackManagement feedBacks) {
	
	System.out.println("\n*-Start method initEntities-*");
		...
		try {
			...
			*/
			...
			//Adding employees
			employees.addEmployee("emp1", "emp1", "emp1", "xxxx", 24,'F',98501100);
			employees.addEmployee("emp2", "emp2", "emp2", "xxxx", 23,'F',98501100);
			employees.addEmployee("emp3", "emp3", "emp3", "xxxx", 26,'M',98501100);
			employees.addEmployee("emp4", "emp4", "emp4", "xxxx", 25,'M',98501100);
			employees.addEmployee("emp5", "emp5", "emp5", "xxxx", 25,'M',98501100);
			...
			*/
			...
			//Adding cars
			cars.addCar(5,"WOLKSWAGEN", "polo", "SUV", "Best Car of the year", "bmw.png", "#ffe9", 2550, 123123);
			cars.addCar(4,"WOLKSWAGEN", "golf", "SUV", "Best Car of the year", "bmw.png", "#ffe9", 2550, 123125);
			cars.addCar(3,"BMW", "SERIE1", "SUV", "Best Car of the year", "bmw.png", "#ffe9", 3000, 1231235);
			...
			//Adding rentals
			/* 
			rentals.addRental(0, 0, "28/11/2020","29/12/2020");
			rentals.addRental(1, 1, "28/11/2020","29/12/2020");
			rentals.addRental(0, 2, "07/11/2020", "30/12/2020");
			rentals.addRental(2, 3, "28/11/2020", "29/11/2020");
			rentals.addRental(1, 4, "28/11/2020", "29/11/2021");
			
			*/
			System.out.println("\n*-End method initEntities-*");
			...
			System.out.println("An Error has occured during the test of initEntities scenario stacktrace : "+e);
			e.printStackTrace();
		}
	...
	public boolean updateRentalsScenario(IEmployManagement employees,ICarsManagement cars,IRentalsManagement rentals,IWaitingManagement WaitingLists,IFeedBackManagement feedBacks) {
		...
		try {
			...
			*/
			...
			//Adding employees
			employees.addEmployee("Skander", "Marnissi", "Skander.marnissi@gmail.com", "xxxx", 24,'M',98521122);
			employees.addEmployee("Hosni", "Mosni", "Hosni.Mosni@gmail.com", "xxxx", 23,'M',98521122);
			employees.addEmployee("Fairouz", "Farfour", "Fairouz.Farfour@gmail.com", "xxxx", 26,'M',98521122);
			employees.addEmployee("Ala", "Mokni", "Mokni.ALA@gmail.com", "xxxx", 25,'M',98521122);
			...
			*/
			...
			cars.addCar(5,"BMW", "Serie 1", "SUV", "Best Car of the year", "bmw.png", "BLUE", 2550, 123123);
			cars.addCar(4,"RENAULT", "Clio", "SUV", "A robust Car", "clio.png", "RED", 2550, 123125);
			cars.addCar(3,"Citroene", "DS4", "SUV", "A smart car", "citroene.png", "BLACK", 3000, 1231235);
			
			/*Test 
			cars.addCar(3,"BMW", "SERIE2", "SUV", "Best Car of the year", "bmw.png", "#ffe9", 5000, 1231235);
			cars.addCar(4,"BMW", "SERIE3", "SUV", "Best Car of the year", "bmw.png", "#ffe9", 6000, 1231234);
			cars.addCar(9,"BMW", "SERIE4", "SUV", "Best Car of the year", "bmw.png", "#ffe9", 7000, 1231239);
			*/
	...
	public void displayUsers(IEmployManagement employees) throws RemoteException  {
		if(!employees.getEmployees().isEmpty()) {
						
						for(IUser e :employees.getUsers() ) {
							System.out.println("\n User id : "+e.getId()+"| Login : "+e.getLogin() +"| Password : "+e.getPassword() +"| Employee Id : "+e.getEmployee_id());
	...
	public static void main(String[] args) throws RemoteException, MalformedURLException  {
		...
		try {
			...
			//sc.initEntities(employees, cars, rentals, WaitingLists, feedBacks);
